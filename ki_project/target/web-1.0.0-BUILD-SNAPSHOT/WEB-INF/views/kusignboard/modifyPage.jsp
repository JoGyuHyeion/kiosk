	...
	<div class="container">
		<form role="form" action="modifyPage" method="post"
			...
			<input type='hidden' name='page' value="${cri.page}"> <input
				...
				type="hidden" name="id_num" value="${kuSignBoardVO.id_num}">

			<div class="page-header">
				<h1>
					KudanSign수정<small>Marker</small>
				</h1>
			</div>
			<div class='form-group'>
				<label><h4>
					...
					placeholder='title' value="${kuSignBoardVO.title}">
			</div>
			<!-- 좌표 -->
			<div class='form-group'>
				<label><h4>
				...
				<div class="form-inline">
					...
					<div class="form-group-sm">
						<input id="datName" class="file_input_textbox form-control"
							readonly value="${kuSignBoardVO.karmarker}" />
