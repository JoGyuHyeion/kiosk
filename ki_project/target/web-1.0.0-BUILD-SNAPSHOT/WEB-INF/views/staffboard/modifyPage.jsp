								...
								<div class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input type="text" class="form-control" placeholder="전화번호"
												id="telno" name="telno" value="${com_staffVO.telno}">
										</div>
									</div>
									<!-- email_addr -->
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input type="text" class="form-control" placeholder="대표업무"
												id="main_task" name="main_task" value="${com_staffVO.main_task}">
										</div>
									</div>
									<!-- adi_info7 -->
									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-md-2 control-label">이미지 파일</label> <input
											...
											readonly="readonly" value="${com_staffVO.img_filenm}" />
							...
							<div class="col-md-5">
								<div class="form-horizontal" role="form">
									...
									<div class = "form-group">
										...
										<div class="col-md-3">
											<input class = "form-control" type="number" name = "st_sort" id = "st_sort" value ="${com_staffVO.st_sort}">
										</div>
									</div>
