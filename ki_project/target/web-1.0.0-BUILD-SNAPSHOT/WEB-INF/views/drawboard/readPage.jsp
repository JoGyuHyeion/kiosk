...
<body>
						...
						function() {
							...
							$("#login")
									.on(
											"click",
											function() {
												self.location = "/user/login?page=${cri.page}&perPageNum=${cri.perPageNum}&id_num=${drawBoardVO.id_num}";
											});
	...
	<form role="form" method="post">
		<input type='hidden' name='id_num' value="${drawBoardVO.id_num}">
	...
	<div class="container">
		<div class="page-header">
			<h1>${drawBoardVO.title}<small>Draw</small>
			</h1>
		</div>
		<c:choose>
		...
		<div class='form-group'>
			...
			<div class='form-inline'>
				<input type='text' class='form-control' name='Lat'
					placeholder="${drawBoardVO.latitude}" disabled> <input
					type='text' class='form-control' name='Lon'
					placeholder="${drawBoardVO.longitude}" disabled>
			</div>
		</div>
		<!-- Marker DataSet -->
		...
		<div class='form-group'>
			...
			<div class="form-inline" style="display: inline">
				<input type='text' id="xmlName" class=" form-control"
					placeholder="${drawBoardVO.xml}" disabled />

			</div>
			<label>Dat </label>
			<div class="form-inline" style="display: inline">
				<input type='text' id="datName" class=" form-control "
					placeholder="${drawBoardVO.dat}" disabled />
			</div>
		</div>
