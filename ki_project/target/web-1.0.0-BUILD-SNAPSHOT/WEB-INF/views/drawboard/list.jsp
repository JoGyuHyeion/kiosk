   ...
   <script>
      ...
      $(document).ready(function() {
               ...
               $("#btn-register").on("click", function() {
                  self.location = "/drawboard/register${pageMaker.makeSearch(cri.page)}";
               });
  ...
  <div id="page-wrapper">
      ...
      <div class="container-fluid">
        <div class="col-lg-12">
         ...
         <c:forEach items="${list}" var="drawBoardVO">
            <tbody>
               <tr align="center">
                  <td>${drawBoardVO.id_num}</td>
                  <td><a
                     href='/drawboard/readPage${pageMaker.makeQuery(pageMaker.cri.page) }&id_num=${drawBoardVO.id_num}'>
                        ${drawBoardVO.title}</a></td>
                  <td>${drawBoardVO.latitude}</td>
                  <td>${drawBoardVO.longitude}</td>
                  <td>${drawBoardVO.xml}</td>
                  <td>${drawBoardVO.regdate}</td>
               </tr>
            </tbody>
               ...
               <th colspan="3">
                  <div class="ui pagination menu">
                     <c:if test="${pageMaker.prev}">
                        <a class="icon item"
                           href="/drawboard/list${pageMaker.makeSearch(startPage - 1)}">&laquo;</a>
                     </c:if>
                     ...
                     <c:forEach begin="${pageMaker.startPage }"
                        ...
                        <div
                           ...
                           <a class="icon item"
                              href="/drawboard/list${pageMaker.makeSearch(idx)}">${idx}</a>
                        </div>
                     </c:forEach>

                     <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                        <a class="icon item"
                           href="/drawboard/list${pageMaker.makeSearch(pageMaker.endPage +1)}">&raquo;</a>
                     </c:if>
                  </div>
               </th>
            </tr>
