   ...
   <script>
      ...
      $(document).ready(function() {
               ...
               $("#btn-register").on("click", function() {
                  self.location = "/geoboard/register${pageMaker.makeSearch(cri.page)}";
               });
  ...
  <div id="page-wrapper">
      ...
      <div class="container-fluid">
        <div class="col-lg-12">
         ...
         <c:forEach items="${list}" var="geoBoardVO">
            <tbody>
               <tr align="center">
                  <td>${geoBoardVO.id_num}</td>
                  <td><a
                     href='/geoboard/readPage${pageMaker.makeQuery(pageMaker.cri.page) }&id_num=${geoBoardVO.id_num}'>
                        ${geoBoardVO.title}</a></td>
                  <td>${geoBoardVO.latitude}</td>
                  <td>${geoBoardVO.longitude}</td>
                  <td>${geoBoardVO.xml}</td>
                  <td>${geoBoardVO.regdate}</td>
               </tr>
            </tbody>
               ...
               <th colspan="3">
                  <div class="ui pagination menu">
                     <c:if test="${pageMaker.prev}">
                        <a class="icon item"
                           href="/geoboard/list${pageMaker.makeSearch(startPage - 1)}">&laquo;</a>
                     </c:if>
                     ...
                     <c:forEach begin="${pageMaker.startPage }"
                        ...
                        <div
                           ...
                           <a class="icon item"
                              href="/geoboard/list${pageMaker.makeSearch(idx)}">${idx}</a>
                        </div>
                     </c:forEach>

                     <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                        <a class="icon item"
                           href="/geoboard/list${pageMaker.makeSearch(pageMaker.endPage +1)}">&raquo;</a>
                     </c:if>
                  </div>
               </th>
            </tr>
