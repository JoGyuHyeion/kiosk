   ...
   <script>
      ...
      $(document).ready(function() {
               ...
               $("#btn-register").on("click", function() {
                  self.location = "/signboard/register${pageMaker.makeSearch(cri.page)}";
               });
  ...
  <div id="page-wrapper">
      ...
      <div class="container-fluid">
        <div class="col-lg-12">
         ...
         <c:forEach items="${list}" var="signBoardVO">
            <tbody>
               <tr align="center">
                  <td>${signBoardVO.id_num}</td>
                  <td><a
                     href='/signboard/readPage${pageMaker.makeQuery(pageMaker.cri.page) }&id_num=${signBoardVO.id_num}'>
                        ${signBoardVO.title}</a></td>
                  <td>${signBoardVO.latitude}</td>
                  <td>${signBoardVO.longitude}</td>
                  <td>${signBoardVO.xml}</td>
                  <td>${signBoardVO.regdate}</td>
               </tr>
            </tbody>
               ...
               <th colspan="3">
                  <div class="ui pagination menu">
                     <c:if test="${pageMaker.prev}">
                        <a class="icon item"
                           href="/signboard/list${pageMaker.makeSearch(startPage - 1)}">&laquo;</a>
                     </c:if>
                     ...
                     <c:forEach begin="${pageMaker.startPage }"
                        ...
                        <div
                           ...
                           <a class="icon item"
                              href="/signboard/list${pageMaker.makeSearch(idx)}">${idx}</a>
                        </div>
                     </c:forEach>

                     <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                        <a class="icon item"
                           href="/signboard/list${pageMaker.makeSearch(pageMaker.endPage +1)}">&raquo;</a>
                     </c:if>
                  </div>
               </th>
            </tr>
