           ...
           .ready(
                 function() {
                    ...
                    $("#modifyBtn").on("click", function() {
                       formObj.attr("action", "/kuaquariumboard/modifyPage");
                       formObj.attr("method", "get");
                       formObj.submit();
                    });

                    $("#removeBtn").on("click", function() {
                       formObj.attr("action", "/kuaquariumboard/removePage");
                       formObj.submit();
                    });
                    ...
                    $("#login").on("click", function() {
                       self.location = "/user/login?page=${cri.page}&perPageNum=${cri.perPageNum}&id_num=${kuAquariumBoardVO.id_num}";
                    });
     ...
     <input type='hidden' name='page' value="${cri.page}"> <input
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
         ...
         <div class="page-header">
             <h1>${kuAquariumBoardVO.title}<small>KudanAquarium</small></h1>
        </div>
                                 <c:choose>
            ...
            <div class='form-group'>
              ...
              <div class='form-inline'>
                <input type='text' class='form-control' name='Lat' placeholder="${kuAquariumBoardVO.latitude}" disabled>
                <input type='text' class='form-control' name='Lon' placeholder="${kuAquariumBoardVO.longitude}" disabled>
              </div>
            </div>
            <!-- Marker DataSet -->
            ...
            <div class='form-group'>
              ...
              <div class="form-inline" style="display: inline">
                  <input type = 'text' id="xmlName" class=" form-control" placeholder="${kuAquariumBoardVO.karmarker}" disabled />
